...
# Injected only when MCP "knowledge base" is selected (see chat.append_tool_guidance_to_prompt).
KNOWLEDGE_BASE_RETRIEVE_GUIDANCE = (
    "## Knowledge Base\n"
    "답변 전에 MCP 도구 retrieve(keyword=<사용자 질문>)를 1회 이상 호출하세요.\n"
)
