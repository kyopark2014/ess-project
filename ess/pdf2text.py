#!/usr/bin/env python3
"""PDF → text for ESS Sync / Wiki Sync semantic staging.
...
def _emit_ess_progress(
    ...
    *,
    ...
    """Print a structured progress line for ESS Sync UI / logs.

    Format::
        [ess progress] name="…" fi=… fn=… p=… pn=… pct=… | human label
    """
    pct: int | None = None
